...
/////////////////
const BotName = 'TADAKI-BOT🤖'; 
const instagram = 'NOTHING-'; 
const telegram = 'NOTHING-'; 
const kapanbotaktif = 'BOT AKTIF DALAM WAKTU 09:00-13:00'; 
const youtube = 'https://youtube.com/channel/UCdAvSEBvcJuZWfm6EybfqSA';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@Gamerz_wibu.edit')
